...
var apiCmdDict = {
  ...
  '^get filesystems ufs$': 'df -m | /usr/bin/awk \'BEGIN { printf "[ "; count=0 } /^\\/dev\\/ufs/ { printf "%s\\n", (++count==1)?"":", "; printf "[ \\"%s\\", %s, %s, %s, \\"%s\\", \\"%s\\" ]", $1, $2, $3, $4, $5, $6 } END { printf "\\n]" }\'',
  '^get filesystem ufs ([a-z]+)$': 'df -m | /usr/bin/awk \'/^\\/dev\\/ufs\\/%1/ { printf "{ \\"total\\": %s, \\"used\\": %s, \\"free\\": %s, \\"percent\\": \\"%s\\", \\"mountpoint\\": \\"%s\\" }", $2, $3, $4, $5, $6 }\'',
  '^get filesystem ufs ([a-z]+) size$': 'df -m | /usr/bin/awk \'/^\\/dev\\/ufs\\/%1/ { printf "%s", $2 }\'',
  '^get filesystem ufs ([a-z]+) used$': 'df -m | /usr/bin/awk \'/^\\/dev\\/ufs\\/%1/ { printf "%s", $3 }\'',
  '^get filesystem ufs ([a-z]+) available$': 'df -m | /usr/bin/awk \'/^\\/dev\\/ufs\\/%1/ { printf "%s", $4 }\'',
  '^get filesystem ufs ([a-z]+) capacity$': 'df -m | /usr/bin/awk \'/^\\/dev\\/ufs\\/%1/ { printf "\\"%s\\"", $5 }\'',
  '^get filesystem ufs ([a-z]+) mountpoint$': 'df -m | /usr/bin/awk \'/^\\/dev\\/ufs\\/%1/ { printf "\\"%s\\"", $6 }\'',
